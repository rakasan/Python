...
class AlienBot:
  ...
  # Define .greet() below:
  def greet(self):
    self.name = input("What's my name? ")
    self.will_help = input(f"Hi {self.name}, I'm Etcetera. I'm not from this planet. Will you help me learn about your planet?")
    if self.will_help.lower() in self.negative_responses:
...
AlienBotInstance = AlienBot()
AlienBotInstance.greet()
